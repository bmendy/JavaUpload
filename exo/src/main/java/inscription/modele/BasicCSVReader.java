...
public class BasicCSVReader {
	...
	public Inscription read(InputStream lInputStream) throws IOException {
		...
		try (
			...
			for (CSVRecord csvRecord : csvParser) {
				...
				String adresse1 = csvRecord.get(3);
				String adresse2 = csvRecord.get(4);
				String CP = csvRecord.get(5);
				String Ville = csvRecord.get(6);

				return new Inscription(nom, prenom, adresse1, adresse2, CP, Ville);
			}
			return null;
		}
